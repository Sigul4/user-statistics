/**
 * Variable for home page route
 */
export const HOMEPAGE_ROUTE = '';

/**
 * Variable for login page route
 */
 ...
 */
export const USER_MANAGEMENT_PAGE_ROUTE = 'admin/user-management';

/**
 * Variable for all not found routes
 */
